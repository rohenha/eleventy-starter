 ...
 * @module utils
 * @example
 * import { ready } from "@scripts/utils/tools.js"
 */
 ...
 */
export const interpolate = (str, params) => str.replace(/\${([^}]+)\}/g, (dummy, v) => params[v] || '')
...
/**
* Function to add multiple 0 before number
*
* @method pad
* @access public
* @param num number
...
/**
* Function to insert script
*
* @method setScript
* @access public
* Put all parameters with @param
* @param src string
* @param src object -> id is required
* @returns { script }
* @example
* setScript("http://script-to-inset.js",{ async: true, id: 'idscript' })
*/
export const setScript = (src, userConf) => {
  ...
  const currentScript = document.querySelector(`#${config.id}`)
  if (currentScript) {
